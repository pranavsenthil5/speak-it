...
public class UserService {
    ...
    private UserDTO mapToDTO(final User user, final UserDTO userDTO) {
        ...
        userDTO.setLinkedinSummary(user.getLinkedinSummary());
        userDTO.setPitchList(user.getPitchList());
        return userDTO;
    }
    ...
    private User mapToEntity(final UserDTO userDTO, final User user) {
        ...
        user.setLinkedinSummary(userDTO.getLinkedinSummary());
        user.setPitchList(userDTO.getPitchList());
        return user;
    }
